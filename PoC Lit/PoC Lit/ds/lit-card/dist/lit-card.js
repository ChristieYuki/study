import { css as w, LitElement as P, html as $ } from "lit";
const U = (i) => (t, e) => {
  e !== void 0 ? e.addInitializer(() => {
    customElements.define(i, t);
  }) : customElements.define(i, t);
};
const l = globalThis, y = l.ShadowRoot && (l.ShadyCSS === void 0 || l.ShadyCSS.nativeShadow) && "adoptedStyleSheets" in Document.prototype && "replace" in CSSStyleSheet.prototype, S = /* @__PURE__ */ Symbol(), _ = /* @__PURE__ */ new WeakMap();
let O = class {
  constructor(t, e, s) {
...
const C = (i) => new O(typeof i == "string" ? i : i + "", void 0, S), A = (i, t) => {
...
}, E = y ? (i) => i : (i) => i instanceof CSSStyleSheet ? ((t) => {
  let e = "";
  for (const s of t.cssRules) e += s.cssText;
  return C(e);
})(i) : i;
const { is: x, defineProperty: M, getOwnPropertyDescriptor: R, getOwnPropertyNames: z, getOwnPropertySymbols: j, getPrototypeOf: T } = Object, u = globalThis, g = u.trustedTypes, D = g ? g.emptyScript : "", L = u.reactiveElementPolyfillSupport, c = (i, t) => i, d = { toAttribute(i, t) {
  switch (t) {
    case Boolean:
      i = i ? D : null;
      break;
  ...
  return e;
} }, m = (i, t) => !x(i, t), b = { attribute: !0, type: String, converter: d, reflect: !1, useDefault: !1, hasChanged: m };
...
class h extends HTMLElement {
  ...
  static finalize() {
    ...
    if (this.finalized = !0, this._$Ei(), this.hasOwnProperty(c("properties"))) {
      const e = this.properties, s = [...z(e), ...j(e)];
  ...
  requestUpdate(t, e, s, r = !1, o) {
    if (t !== void 0) {
      ...
      if (r === !1 && (o = this[t]), s ??= n.getPropertyOptions(t), !((s.hasChanged ?? m)(o, e) || s.useDefault && s.reflect && o === this._$Ej?.get(t) && !this.hasAttribute(n._$Eu(t, s)))) return;
      this.C(t, e, s);
    }
...
h.elementStyles = [], h.shadowRootOptions = { mode: "open" }, h[c("elementProperties")] = /* @__PURE__ */ new Map(), h[c("finalized")] = /* @__PURE__ */ new Map(), L?.({ ReactiveElement: h }), (u.reactiveElementVersions ??= []).push("2.1.2");
const k = { attribute: !0, type: String, converter: d, reflect: !1, hasChanged: m }, q = (i = k, t, e) => {
...
function N(i) {
  return (t, e) => typeof e == "object" ? q(i, t, e) : ((s, r, o) => {
    const n = r.hasOwnProperty(o);
    return r.constructor.createProperty(o, s), n ? Object.getOwnPropertyDescriptor(r, o) : void 0;
  })(i, t, e);
}
var B = Object.defineProperty, H = Object.getOwnPropertyDescriptor, v = (i, t, e, s) => {
...
let p = class extends P {
  ...
  render() {
    return $`
      ...
      ${this.open ? $`<slot name="body"></slot>` : void 0}
